...
train_rf_tuned <-  train(SHOT_RESULT ~ ., data = train_set_RF,
                   method = "ranger", 
                   tuneGrid = expand.grid(.mtry = 2:4, .splitrule = "gini", .min.node.size = c(1)),
                   num.trees = 100,
                   trControl = control_RF)
##train_rf_tuned works
rain_rf_tuned <-  train(SHOT_RESULT ~ ., data = train_set_RF,
                   method = "ranger", 
                   num.trees = 100,
                   trControl = control_RF)
