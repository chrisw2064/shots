...
shots_updated <- shots %>% left_join(positions, by = "player_name") %>% left_join(positions, by = c("CLOSEST_DEFENDER" = "player_name"))
##there is a position and rid for both need to rename the variables...
