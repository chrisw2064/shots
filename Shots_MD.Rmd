...
#now fit a model
fit_glm_shots <- glm(SHOT_NUMERIC ~ GAME_CLOCK + SHOT_CLOCK + DRIBBLES + TOUCH_TIME + PTS_TYPE + CLOSE_DEF_DIST*SHOT_DIST*MISMATCH, data = train_set_glm_shots, family = "binomial")
