...
#
xgb_grid_1 <- expand.grid(eta = c(0.01, 0.05, 0.1, 0.3, 0.5),  
                            colsample_bytree=c(0.5,0.7, 1),
                            max_depth=c(3,6),
                            nrounds= c(10, 50, 100, 200),
                            gamma=1,
...
xgb_train_1
xgb_shots <- xgboost(data = matrix_train_xgboost, label = as.factor(xg_labels_train), params = xgb_train_1$bestTune, nrounds = 100)
